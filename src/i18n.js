export const LANGS = [
  ...
  export const STRINGS = {
    ...
    ja: {
      ...
      storyTitle: "ストーリー",
      storyLead:
        "東京の酒好きグルメなサラリーマン3人が、本当に美味しい東京の飲み屋ナイトを海外の皆様にも体験いただきたく、仕事終わりの研究を積み重ねてきました。Omakaseする店舗はすべて3人のうち誰かが実際に足を運んで厳選しています。テーマは、観光客がまだ見つけていないお店で、最高のIzakaya Drinking Nightを。",
